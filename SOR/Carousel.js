...
function UpdateUi()
{
	...
	}else
	{
		...
		leftimage.src = image[currentcontext - 1]; 
	}
	...
	}else
	{
		...
		rightimage.src = image[currentcontext + 1]; 
	}
	
	centerimage.src =image[currentcontext];
}
...
$(document).ready(function(){
   /* $.getJSON('English.json',function(data)
	...
	select.onclick = function()
	{
		...
		document.location.href = link[currentcontext];
	}
